...
const VenuePage = () => {
  ...
  const handleNext = () => {
    ...
    const selectedOption = venueOptions.find(opt => opt.tier === selectedTier);
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          <div className="flex items-center justify-center gap-2 mb-4">
            ...
            <h1 className="text-3xl font-serif text-rose-800">Choose Your Venue</h1>
          </div>
          <p className="text-rose-600">Select the perfect location for your special day</p>

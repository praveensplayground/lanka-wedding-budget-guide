  ...
  const photographyOptions = [
    {
      ...
      features: ["Basic photography package", "1 photographer", "Digital photos", "Basic editing"],
      color: "from-green-400 to-emerald-500"
    },
    {
      tier: "mid",
      title: "Mid-Range Photography",
      price: "LKR 180,000 - 250,000",
      priceRange: [180000, 250000],
      features: ["Photo + Video package", "2 photographers", "Drone shots", "Professional editing", "Photo album"],
    ...
    },
    {
      ...
      features: ["Full cinematic package", "3+ photographers", "4K video", "Same-day highlights", "Luxury album & prints"],
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="text-center mb-8">
          <div className="flex items-center justify-center gap-2 mb-4">
            ...
            <h1 className="text-3xl font-serif text-rose-800">Photography & Videography</h1>
          </div>
          <p className="text-rose-600">Capture your special moments forever</p>
          <p className="text-sm text-rose-500 mt-2">Fixed price service</p>
        </div>
          ...
          {photographyOptions.map((option) => (
            ...
            >
              <CardHeader>
                ...
                <div className="text-sm text-rose-500">total package</div>
              </CardHeader>
              <CardContent>

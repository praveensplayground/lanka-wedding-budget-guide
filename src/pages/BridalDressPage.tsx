...
const bridalDressOptions = [
  {
    tier: "budget",
    title: "Budget Bridal Dress",
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="text-center mb-8">
          <div className="flex items-center justify-center gap-2 mb-4">
            ...
            <h1 className="text-3xl font-serif text-rose-800">Bridal Dress</h1>
          </div>
          <p className="text-rose-600">Choose the perfect dress for your special day</p>
        </div>
        <div className="grid md:grid-cols-3 gap-6 max-w-6xl mx-auto mb-8">
          {bridalDressOptions.map((option) => (
            <Card 
              key={option.tier}
...
export default BridalDressPage;
